            ...
            <div className="max-w-2xl mx-auto">
              <Card className="gradient-card p-8 text-center shadow-elevated animate-slide-up">
                ...
                <p className="text-muted-foreground mb-4">
                  One-time activation fee of KSh 150 is required to verify your account.
                </p>
                <div className="bg-success/10 border border-success/30 rounded-lg p-3 mb-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your KSh 150 activation fee will be refunded to your account balance once you reach 
