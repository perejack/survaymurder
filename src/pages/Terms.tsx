        ...
        <Card className="p-8 shadow-lg">
          ...
          <div className="bg-muted p-4 rounded-lg mb-8">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <strong>Address:</strong> P.O. Box 34567-00100, Nairobi, LENANA BUILDING, LENANAN ROAD, NAIROBI<br />
          ...
          <div className="space-y-6 text-sm text-muted-foreground">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>Business Name: EarnSpark</li>
                <li>Registered Address: P.O. Box 34567-00100, Nairobi, LENANA BUILDING, LENANAN ROAD, NAIROBI</li>
