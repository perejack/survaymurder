    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-3">
        ...
        <div className="flex items-center justify-center gap-2 flex-wrap px-4">
          <Badge variant="secondary" className="text-xs py-1.5 px-3 rounded-full">
            ⭐ KSh 150 per survey
          </Badge>
          <Badge variant="outline" className="text-xs py-1.5 px-3 rounded-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {categories.map((category, index) => (
          <Card 
            key={category.id}
            className="group relative overflow-hidden mobile-card bg-card hover-lift border-border/30 animate-slide-up hover:shadow-elevated active:scale-95 transition-all duration-200"
            ...
            <div className="relative p-5 space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-2xl font-bold gradient-earning bg-clip-text text-transparent mt-1">
              ...
              <div className="grid grid-cols-3 gap-3 py-3 border-t border-border/50">
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium">{category.time}</p>
                </div>
                <div className="text-center">
                  <p className="text-xs text-muted-foreground">Questions</p>
                  <p className="text-sm font-medium">{category.questions}</p>
                </div>
                <div className="text-center">
              ...
              <Button 
                ...
                className={`w-full mobile-button bg-gradient-to-r ${category.gradient} text-white border-0 hover:opacity-90 active:scale-95 transition-all duration-200 shadow-lg font-semibold`}
              >
                Open Survey
              </Button>
            </div>
