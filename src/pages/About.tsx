          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="bg-muted p-4 rounded-lg space-y-2">
                ...
                <p className="text-sm">
                  <strong>Registered Address:</strong> P.O. Box 34567-00100, Nairobi, LENANA BUILDING, LENANAN ROAD, NAIROBI
                </p>
                <p className="text-sm">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                EarnSpark is a task-based platform. We connect 
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                We are committed to operating EarnSpark with transparency and integrity. 
            ...
            <section>
              ...
              <div className="bg-muted p-4 rounded-lg space-y-3">
                ...
                <div className="text-sm space-y-2">
                  ...
                  <p><strong>Address:</strong> P.O. Box 34567-00100, Nairobi, LENANA BUILDING, LENANAN ROAD, NAIROBI, KENYA</p>
                </div>
